...
# -*- coding: utf-8 -*-
#
# observable_jupyter_widget documentation build configuration file
#
...
project = 'observable_jupyter_widget'
copyright = '2021, Thomas Ballinger'
...
_version_py = os.path.join(repo, 'observable_jupyter_widget', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'observable_jupyter_widgetdoc'
...
latex_documents = [
    (master_doc, 'observable_jupyter_widget.tex', 'observable_jupyter_widget Documentation',
...
man_pages = [
    (master_doc,
    'observable_jupyter_widget',
    'observable_jupyter_widget Documentation',
     [author], 1)
]
