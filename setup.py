...
data_files_spec = [
    ('share/jupyter/nbextensions/observable_jupyter_widget', 'observable_jupyter_widget/nbextension', '**'),
    ('share/jupyter/labextensions/observable-jupyter-widget', 'observable_jupyter_widget/labextension', '**'),
